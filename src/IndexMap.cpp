...
: indexProgram(loadProgramFromFile("index_map.vert", "index_map.frag")),
  indexRenderBuffer(Config::W() * IndexMap::FACTOR, Config::H() * IndexMap::FACTOR),
  indexTexture(Config::W() * IndexMap::FACTOR,
               Config::H() * IndexMap::FACTOR,
               GL_R32I,
               GL_RED_INTEGER,
               GL_INT),
  vertConfTexture(Config::W() * IndexMap::FACTOR,
                  Config::H() * IndexMap::FACTOR,
                  GL_RGBA32F, GL_RGBA, GL_FLOAT),
  colorTimeTexture(Config::W() * IndexMap::FACTOR,
                   Config::H() * IndexMap::FACTOR,
                   GL_RGBA32F, GL_RGBA, GL_FLOAT),
  normalRadTexture(Config::W() * IndexMap::FACTOR,
                   Config::H() * IndexMap::FACTOR,
                   GL_RGBA32F, GL_RGBA, GL_FLOAT)
//  drawDepthProgram(loadProgramFromFile("empty.vert", "quad.geom", "visualise_textures.frag")),
//  drawRenderBuffer(Config::W(), Config::H()),
//  drawTexture(Config::W(), Config::H(),
//              GL_RGBA,
//              GL_RGB,
//              GL_UNSIGNED_BYTE,
//              false),
//  depthProgram(loadProgramFromFile("splat.vert", "depth_splat.frag")),
//  depthRenderBuffer(Config::W(), Config::H()),
//  depthTexture(Config::W(), Config::H(),
//               GL_LUMINANCE32F_ARB,
//               GL_LUMINANCE,
//               GL_FLOAT,
//               false,
...
//  combinedRenderBuffer(Config::W(), Config::H()),
//  imageTexture(Config::W(), Config::H(),
//               GL_RGBA,
//               GL_RGB,
//               GL_UNSIGNED_BYTE,
//               false,
//               true),
//  vertexTexture(Config::W(), Config::H(),
//                GL_RGBA32F, GL_LUMINANCE, GL_FLOAT, false, true),
//  normalTexture(Config::W(), Config::H(),
//                GL_RGBA32F, GL_LUMINANCE, GL_FLOAT, false, true),
//  timeTexture(Config::W(), Config::H(),
//              GL_LUMINANCE16UI_EXT,
//              GL_LUMINANCE_INTEGER_EXT,
//              GL_UNSIGNED_SHORT,
//              false,
//              true),
//  oldRenderBuffer(Config::W(), Config::H()),
//  oldImageTexture(Config::W(), Config::H(),
//                  GL_RGBA,
//                  GL_RGB,
//                  GL_UNSIGNED_BYTE,
//                  false,
//                  true),
//  oldVertexTexture(Config::W(), Config::H(),
//                   GL_RGBA32F, GL_LUMINANCE, GL_FLOAT, false, true),
//  oldNormalTexture(Config::W(), Config::H(),
//                   GL_RGBA32F, GL_LUMINANCE, GL_FLOAT, false, true),
//  oldTimeTexture(Config::W(), Config::H(),
//                 GL_LUMINANCE16UI_EXT,
//                 GL_LUMINANCE_INTEGER_EXT,
//                 GL_UNSIGNED_SHORT,
//                 false,
//                 true),
//  infoRenderBuffer(Config::W(), Config::H()),
//  colorInfoTexture(Config::W() * IndexMap::FACTOR,
//                   Config::H() * IndexMap::FACTOR,
//                   GL_RGBA32F, GL_LUMINANCE, GL_FLOAT),
//  vertexInfoTexture(Config::W() * IndexMap::FACTOR,
//                    Config::H() * IndexMap::FACTOR,
//                   GL_RGBA32F, GL_LUMINANCE, GL_FLOAT),
//  normalInfoTexture(Config::W() * IndexMap::FACTOR,
//                    Config::H() * IndexMap::FACTOR,
//                    GL_RGBA32F, GL_LUMINANCE, GL_FLOAT)
                              ...
                              const int timeDelta)
{
    ...
    Eigen::Vector4f cam(Config::cx() * IndexMap::FACTOR,
                        Config::cy() * IndexMap::FACTOR,
                        Config::fx() * IndexMap::FACTOR,
                        Config::fy() * IndexMap::FACTOR);
    ...
    indexProgram->setUniform(Uniform("cols", (float)Config::W() * IndexMap::FACTOR));
    indexProgram->setUniform(Uniform("rows", (float)Config::H() * IndexMap::FACTOR));
    ...
    glDrawArrays(GL_POINTS, 0, model.second);
